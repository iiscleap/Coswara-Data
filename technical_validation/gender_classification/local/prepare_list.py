...
def main(annotation_file, metadata_file, pathfile, outlist, outpath):
    ...
    for fid in df_annotation_drop.id.values:
        genders.append(df_metadata[df_metadata.id==fid].g.values[0])
    df_annotation_drop['gender'] = genders
...
if __name__=='__main__':
    ...
    main(args.annotation, args.metadata_file, args.pathfile, args.outlist, args.outpath)